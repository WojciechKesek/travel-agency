...
class OfferRepositoryTest {
    ...
    public void shouldFindByName() {
        ...
        Offer offer = new Offer("testOffer", BigDecimal.valueOf(100),1, hotelRepository.findAll().get(0));
    ...
    public void shouldFindOffersByHotel() {
        ...
        Offer offer = new Offer("testOffer", BigDecimal.valueOf(100),1, hotel);
        offerRepository.save(offer);
    ...
    public void shouldFindByPriceGreaterThanAndPriceLessThanOrderByPriceDesc() {
        Hotel hotel = hotelRepository.findAll().get(0);
        Offer offerInRangeIndex0 = new Offer("offerInRangeIndex0", BigDecimal.valueOf(1200), 1, hotel);
        Offer offerInRangeIndex1 = new Offer("offerInRangeIndex1", BigDecimal.valueOf(1000), 1, hotel);
        Offer offerOutsideRange = new Offer("offerOutsideRange", BigDecimal.valueOf(2000), 1, hotel);
